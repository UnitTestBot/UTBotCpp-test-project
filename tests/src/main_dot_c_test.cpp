...
TEST(regression, main_test_1)
{
    ...
    EXPECT_EQ(0, actual);
    char expected_argv[2][2] = {{'c', 'b'}, {'\f', 'B'}};
...
TEST(regression, main_test_6)
{
    ...
    int actual = main(2, argv);
    EXPECT_EQ(0, actual);
    char expected_argv[2][2] = {{'c', 'b'}, {'\f', 'p'}};
