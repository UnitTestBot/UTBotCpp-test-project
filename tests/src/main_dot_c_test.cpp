...
TEST(regression, main_test_1)
{
    ...
    EXPECT_EQ(0, actual);
    char expected_argv[2][2] = {{'c', 'c'}, {'\f', 'A'}};
...
TEST(regression, main_test_3)
{
    ...
    EXPECT_EQ(1, actual);
    char expected_argv[2][2] = {{'c', 'c'}, {'b', 'c'}};
...
TEST(regression, main_test_6)
{
    ...
    int actual = main(2, argv);
    EXPECT_EQ(0, actual);
    char expected_argv[2][2] = {{'c', 'c'}, {'\f', 'j'}};
