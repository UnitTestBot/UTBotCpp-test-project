...
TEST(regression, main_test_7)
{
    ...
    EXPECT_EQ(1, actual);
    char expected_argv[2][2] = {{'c', 'a'}, {'a', 'a'}};
...
TEST(regression, main_test_10)
{
    ...
    int actual = main(2, argv);
    EXPECT_EQ(1, actual);
    char expected_argv[2][2] = {{'c', 'a'}, {'1', '\0'}};
